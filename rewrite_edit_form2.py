...
edit_form_regex = re.compile(r'<div transition:slide\|local class="space-y-4">.*?Salva Modifiche\s*</button>\s*</div>\s*</div>', re.DOTALL)
edit_form_replacement = """<div transition:slide class="space-y-4 w-full bg-white dark:bg-gray-800 p-1">
										<!-- Row 1: Nome, URL -->
