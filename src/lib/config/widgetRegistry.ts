...
export const WIDGET_REGISTRY: WidgetDef[] = [
    ...
    fields: [
      {
        ...
        label: "Socket Path (es: /var/run/docker.sock)",
        type: "text",
      },
      {
  ...
  },
  {
    id: "weather",
    name: "Meteo",
    icon: "noto:sun-behind-large-cloud",
  ...
  },
  {
    ...
    description: "Impostazioni per l'API JSON-RPC di OpenWRT (ubus)",
    fields: [
      {
        id: "openwrt_url",
        label: "URL",
        type: "url",
        description: "Es: http://192.168.1.1",
      },
      { id: "openwrt_username", label: "Username", type: "text" },
...
export function getWidgetRequireAuthKey(
