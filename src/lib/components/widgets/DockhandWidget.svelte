...
<div class="h-full w-full flex flex-col p-2  overflow-hidden text-card-foreground">
	{#if !hideHeader}
	...
	<div class="flex flex-col flex-1 min-h-0 overflow-y-auto custom-scrollbar pr-1 max-lg:max-h-[250px]">
		{#if query.isPending}
