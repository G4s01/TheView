			...
			{:else}
				<div transition:slide class="space-y-4 max-w-sm">
					<div>
						...
						<div class="relative">
							<input type={showAdminPassword ? "text" : "password"} bind:value={adminPassword} class="block w-full px-4 py-2.5 pr-10 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all dark:text-gray-50">
					...
					<div>
						...
						<input type="password" bind:value={adminPasswordConfirm} class="block w-full px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all dark:text-gray-50">
					</div>
