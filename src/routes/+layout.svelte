	...
	<header class="sticky top-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
		<div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-16">
			...
			<nav class="hidden md:flex items-center space-x-1 flex-1 px-8 overflow-x-auto no-scrollbar">
				<a href="/" class="px-3 py-1.5 text-sm font-medium rounded-full bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-200 whitespace-nowrap">
					All
				</a>
			...
			<div class="flex items-center space-x-2 sm:space-x-4">
				...
				<button 
					class="p-2 transition-colors {appState.isEditMode ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 rounded-md' : 'text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white'}"
					onclick={() => {
		...
		<nav class="md:hidden flex items-center space-x-2 px-4 py-3 overflow-x-auto border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800/90 no-scrollbar">
			<a href="/" class="px-3 py-1 text-sm font-medium rounded-full bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-200 whitespace-nowrap">
				All
			</a>
			{#each categories as category}
