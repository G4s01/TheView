...
export async function load({ locals }) {
  ...
  return {
    ...
    needsSetup,
    showCategoriesDesktop: settings.showCategoriesDesktop === 'true' || settings.showCategoriesDesktop === true,
    showCategoriesMobile: settings.showCategoriesMobile === 'true' || settings.showCategoriesMobile === true,
    customNavbarTitleDesktop:
      settings.customNavbarTitleDesktop || settings.customNavbarTitle || "HOMELAB",
    customNavbarTitleMobile:
      settings.customNavbarTitleMobile || settings.customNavbarTitle || "HOMELAB",
    showCategoryCounts: settings.showCategoryCounts === 'true' || settings.showCategoryCounts === true,
    showServiceDescriptionsDesktop: settings.showServiceDescriptionsDesktop === 'false' || settings.showServiceDescriptionsDesktop === false ? false : (settings.showServiceDescriptionsDesktop === 'true' || settings.showServiceDescriptionsDesktop === true ? true : (settings.showServiceDescriptions !== false)),
    showServiceDescriptionsMobile: settings.showServiceDescriptionsMobile === 'true' || settings.showServiceDescriptionsMobile === true,
    ...
    editServiceSheetPosition: settings.editServiceSheetPosition || "left",
    settings,
    usedWidgetTypes,
  };
}
